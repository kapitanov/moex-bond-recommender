...
(
	...
	listing_level         int       NOT NULL,
	coupon_freq           int       NOT NULL,
    created               timestamp NOT NULL,
    updated               timestamp NOT NULL
);
...
CREATE TABLE offers
(
    id                 int       NOT NULL GENERATED BY DEFAULT AS IDENTITY CONSTRAINT pk_offers PRIMARY KEY,
    bond_id            int       NOT NULL CONSTRAINT "FK_bond_offers" REFERENCES bonds ON DELETE CASCADE,
    issue_value        numeric   NULL,
    date               date      NULL,
