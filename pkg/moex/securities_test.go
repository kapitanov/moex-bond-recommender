...
[
...

	{
		...
		assert.Equal(int(66310675), securities[0].ID)
...

	{
		...
		assert.NotNil(securities)
		assert.Equal(1, len(securities))
		assert.Equal(int(93129041), securities[0].ID)
